[![Run App Zach Kozak](https://github.com/zachkozak/GithubActions/actions/workflows/run-app.yaml/badge.svg)](https://github.com/zachkozak/GithubActions/actions/workflows/run-app.yaml)
